...
## 从全局变量中引用lengthfreight变量
from config import lengthfreight,hive_conn
...
def main():
    ...
    hiveDB=lengthfreight.hiveDB or hive_conn.hiveDB
    hiveTable=lengthfreight.hiveTable or hive_conn.hiveTable
    ...
    ## 存储结果到mysql数据库
    mysql_update(dataLabel=lengthfreight.label, dataValues=outputStr)
