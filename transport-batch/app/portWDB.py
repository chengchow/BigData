...
## 从全局变量中引用portWDB变量
from config import portWDB,hive_conn,query
...
def main():
    ...
    ##获取hive连接信息
    hiveDB=portWDB.hiveDB or hive_conn.hiveDB
    hiveTable=portWDB.hiveTable or hive_conn.hiveTable
    ...
    ## 存储结果到mysql数据库
    mysql_update(dataLabel=portWDB.label, dataValues=outputStr)
