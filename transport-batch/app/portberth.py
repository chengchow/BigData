...
## 从全局变量中引用portberth变量
from config import portberth,hive_conn,query
...
def main():
    ...
    ##获取hive连接信息
    hiveDB=portberth.hiveDB or hive_conn.hiveDB
    hiveTable=portberth.hiveTable or hive_conn.hiveTable
    ...
    ## 存储结果到mysql数据库
    mysql_update(dataLabel=portberth.label, dataValues=outputStr)
